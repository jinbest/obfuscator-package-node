...
async function init() {
  ...
  if (w > ipad_size) {
    ...
    document.getElementById("camera_div").style.width = w + "px";
    document.getElementById("camera_div").style.height = h + "px";
    ...
    document.getElementById("maincamera").style.height = "100%";
    ...
    if (cntBrowser == "firefox") {
      ...
      document.getElementById("camera_div").style.marginTop = "0px";
      document.getElementById("camera_div").style.marginLeft = "0px";
      // document.getElementById("camera_div").style.transform = `scale(${
      //   (zoommain * 1.04) / 100
      // })`; //`scale(${(zoommain/100)})`;
    } else {
...
/*  if (w > ipad_size) {
  ...
  document.getElementById(buybtndiv.id).innerHTML = `
    <img src="img/images/buynow.gif" style="width: 100%; height: 100%" />
  `;
...
$(window).resize(function () {
  ...
  if (cntW > ipad_size) {
    ...
    document.getElementById("camera_div").style.width = "100%";
    document.getElementById("camera_div").style.height = "100%";
    ...
    document.getElementById("maincamera").style.height = cntH + "px";
...
function MobileInitCaseAlignCustomize() {
  ...
  document.getElementById("menu").style.bottom = "174px";
  document.getElementById("upload_livebtn").style.bottom = "181px";
  document.getElementById("uploadbtn").style.bottom = "176px";
  document.getElementById("download_bttn_up").style.bottom = "255px";
  document.getElementById("flipCamera").style.bottom = "175px";
  document.getElementById("pentagon").style.bottom = "180px";
}
...
setInterval(function() {
  document.getElementById("menu").style.bottom = "35px";
  document.getElementById("flipCamera").style.bottom = "35px";
  document.getElementById("upload_livebtn").style.bottom = "35px";
  document.getElementById("uploadbtn").style.bottom = "35px";
  document.getElementById("download_bttn_up").style.bottom = "105px";
  document.getElementById("pentagon").style.bottom = "35px";
}, 100)
